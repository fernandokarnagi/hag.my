...
export function LeadForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      if (isEdit && id) {
        await updateLead.mutateAsync({ id, data: form as any });
      ...
      <form onSubmit={handleSubmit} className="card p-6">
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
          <Field label="Client Name" required>
            <input type="text" value={form.clientName} onChange={(e) => updateField('clientName', e.target.value)} className="input-field" required />
          </Field>
          <Field label="Contact Details" required>
            <input type="text" value={form.contactDetails} onChange={(e) => updateField('contactDetails', e.target.value)} className="input-field" required />
          </Field>
          <Field label="Status">
          ...
          <Field label="Location">
            <input type="text" value={form.location} onChange={(e) => updateField('location', e.target.value)} className="input-field" placeholder="e.g. Kota Kinabalu" />
          </Field>
          <Field label="GPS Pin">
            <input type="text" value={form.gpsPin} onChange={(e) => updateField('gpsPin', e.target.value)} className="input-field" placeholder="lat,long" />
          </Field>
          ...
          <Field label="Avg Monthly Bill (RM)">
            <input type="text" value={form.avgMonthlyBill} onChange={(e) => updateField('avgMonthlyBill', e.target.value)} className="input-field" placeholder="e.g. 300-500" />
          </Field>
          ...
          <Field label="Sales Executive">
            <input type="text" value={form.salesExecutive} onChange={(e) => updateField('salesExecutive', e.target.value)} className="input-field" />
          </Field>
          <Field label="Site Visit Done By">
            <input type="text" value={form.siteVisitDoneBy} onChange={(e) => updateField('siteVisitDoneBy', e.target.value)} className="input-field" />
          </Field>
          <Field label="Proposal Prepared By">
            <input type="text" value={form.proposalPreparedBy} onChange={(e) => updateField('proposalPreparedBy', e.target.value)} className="input-field" />
          </Field>
          <Field label="Proposed Capacity (kWp)">
            <input type="text" value={form.proposedCapacity} onChange={(e) => updateField('proposedCapacity', e.target.value)} className="input-field" />
          </Field>
          <Field label="Project Value (RM)">
            <input type="text" value={form.projectValue} onChange={(e) => updateField('projectValue', e.target.value)} className="input-field" />
          </Field>
          <Field label="Customer Folder">
            <input type="text" value={form.customerFolder} onChange={(e) => updateField('customerFolder', e.target.value)} className="input-field" />
          </Field>
          <div className="md:col-span-2 lg:col-span-3">
            <Field label="Remarks">
              <textarea value={form.remarks} onChange={(e) => updateField('remarks', e.target.value)} rows={3} className="input-field resize-none" />
            </Field>
          </div>
        </div>
